...
PileupJetIdentifier PileupJetIdAlgo::computeIdVariables( const pat::Jet * jet,//const reco::Vertex * vtx, 
							 const edm::PtrVector<pat::PackedCandidate> PtrCandAll,
							 const edm::Ptr<reco::Vertex> vtx,
							 const std::map<edm::Ptr<reco::Vertex>,edm::PtrVector<pat::PackedCandidate> >& vtxmap,
							 bool  calculateMva,
  ...
  float * coneFracs[]     = { &internalId_.frac01_    , &internalId_.frac02_    , 
			      &internalId_.frac03_    , &internalId_.frac04_    ,
                              &internalId_.frac05_    , &internalId_.frac06_    ,  
			      &internalId_.frac07_   };
  
  float * coneEmFracs[]   = { &internalId_.emFrac01_  , &internalId_.emFrac02_  , 
			      &internalId_.emFrac03_  , &internalId_.emFrac04_  ,
                              &internalId_.emFrac05_  , &internalId_.emFrac06_  , 
			      &internalId_.emFrac07_  };
  
  float * coneNeutFracs[] = { &internalId_.neutFrac01_, &internalId_.neutFrac02_, 
			      &internalId_.neutFrac03_, &internalId_.neutFrac04_,
                              &internalId_.neutFrac05_, &internalId_.neutFrac06_, 
			      &internalId_.neutFrac07_};
  
  float * coneChFracs[]   = { &internalId_.chFrac01_  , &internalId_.chFrac02_  , 
			      &internalId_.chFrac03_  , &internalId_.chFrac04_  ,
                              &internalId_.chFrac05_  , &internalId_.chFrac06_  , 
							...
							bool calculateMva) 
{
  ...
  //	std::cout << " SCZ DEBUG just reset variables " << std::endl;
  ...
  //        std::cout << " SCZ DEBUG just cast jet " << std::endl;
  ...
  //	std::cout << " SCZ DEBUG just got constituents " << std::endl;
  ...
  //	std::cout << " SCZ DEBUG just set nvtx " << std::endl;

	
  for(constituents_iterator it=constituents.begin(); it!=constituents.end(); ++it) {
    //	  std::cout << " SCZ DEBUG start of a constituent " << std::endl;
    ...
    //		std::cout << " SCZ DEBUG end of a constituent " << std::endl;
  }
