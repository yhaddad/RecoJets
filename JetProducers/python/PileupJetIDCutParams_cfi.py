...
###########################################################
full_53x_wp_met  = cms.PSet(
                #4 Eta Categories  0-2.5 2.5-2.75 2.75-3.0 3.0-5.0

                #Loose Id (dummy cuts)
                Pt010_Tight     = cms.vdouble(-0.2,-0.3,-0.5,-0.5),
                Pt1020_Tight    = cms.vdouble(-0.2,-0.2,-0.5,-0.3),
                Pt2030_Tight    = cms.vdouble(-0.2,-0.2,-0.2, 0.2),
                Pt3050_Tight    = cms.vdouble(-0.2,-0.2, 0. , 0.2),

                #Loose Id (dummy cuts)
                Pt010_Medium    = cms.vdouble(-0.2,-0.3,-0.5,-0.5),
                Pt1020_Medium   = cms.vdouble(-0.2,-0.2,-0.5,-0.3),
                Pt2030_Medium   = cms.vdouble(-0.2,-0.2,-0.2, 0.2),
                Pt3050_Medium   = cms.vdouble(-0.2,-0.2, 0. , 0.2),

                #Loose Id
                Pt010_Loose    = cms.vdouble(-0.2,-0.3,-0.5,-0.5),
                Pt1020_Loose   = cms.vdouble(-0.2,-0.2,-0.5,-0.3),
                Pt2030_Loose   = cms.vdouble(-0.2,-0.2,-0.2, 0.2),
